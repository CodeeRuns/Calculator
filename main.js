...
function addNumberToDisplay(event, number) {
    //Button after calculation clicked
    ...
    // Display first number
        ...
        //When Subtract oprator clicked first
...
function addOperator(opr) {
    //Calculate after two numbers entered
...
function deleteFromDisplay() {
    if (display.textContent === "0" || display.textContent === "" || firstNumer === "0") {
        clear();
    }
    else {
